...
export function buildCmdList(context) {
  ...
  CMD_LIST = [
    ...
    { icon: '💬', label: 'Go to Chat',           cat: 'Navigate', action: () => switchMainTab('chat'),      sc: '6' },
    { icon: '☀️', label: 'Go to Briefing',       cat: 'Navigate', action: () => switchMainTab('briefing'), sc: '7' },
    { icon: '💡', label: 'Go to Brainstorm',     cat: 'Navigate', action: () => switchMainTab('brainstorm'), sc: '8' },
